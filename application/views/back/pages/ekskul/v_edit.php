        ...
        <div class="card-body">
            <form action="<?= site_url('c_ekskul/update/'.$ekskul->id) ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="deskripsi" id="deskripsi" class="form-control" rows="4" required><?= $ekskul->deskripsi ?></textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <?php if (!empty($ekskul->foto)): ?>
                        <p><img src="<?= base_url('uploads/ekskul/'.$ekskul->foto) ?>" width="100" class="img-thumbnail"></p>
                    <?php endif; ?>
