...
public function __construct()
	...
	public function index()
	{
		...
		// 🔹 Tambahan baru
		$data['total_videos']	 = $this->videos->totalVideos();
		$data['total_ekskul'] = $this->ekskul->totalEkskul();
		 $data['total_prestasi']    = $this->prestasi->totalPrestasi();
		 $data['total_guru'] = $this->guru->totalGuru();
